...
TEST(DungeonTest, AddNPCAndPrintAll)
{
    ...
    dungeon.addNPC("Orc", "Gorg", 5, 15);
    dungeon.addNPC("Knight", "Arthur", 7, 14);
    ...
    EXPECT_NE(printed.find("Orc Gorg (5, 15)"), std::string::npos);
    EXPECT_NE(printed.find("Knight Arthur (7, 14)"), std::string::npos);
}

TEST(DungeonTest, BattleKillsNPC)
{
    Dungeon dungeon(50.0);
    dungeon.addNPC("Orc", "Gorg", 0, 0);
    dungeon.addNPC("Bear", "Baloo", 10, 10);
...
TEST(DungeonTest, SaveAndLoadFromFile)
{
    ...
    dungeon1.addNPC("Knight", "Arthur", 5, 15);
    ...
    EXPECT_NE(printed.find("Bear Baloo (10, 20)"), std::string::npos);
    EXPECT_NE(printed.find("Knight Arthur (5, 15)"), std::string::npos);
